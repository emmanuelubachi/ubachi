...
const FeatureCard = () => {
  return (
    <div
      ...
      shadow-gray-200
      hover:bg-gradient-to-tr hover:from-indigo-500 hover:to-pink-500 focus:ring-4 focus:outline-none
      text-gray-900 hover:text-white
      transition-transform hover:scale-105 cursor-pointer"
    >
      <svg
        className="w-10 h-19 focus:ring-4 focus:outline-none mb-3"
        aria-hidden="true"
